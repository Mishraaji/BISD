...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; Other Help Details
	</div>
						</br>
						<h4>Have you ever applied for SID before ? </h4>
						<p>Check the radio button yes or no as per your SID application history.
						</p>
						<h4>Have you been at any time debarred for obtaining: </h4>
						<p>Check the radio button yes or no as per your debarred history for CDC and SID respectively.</p>
