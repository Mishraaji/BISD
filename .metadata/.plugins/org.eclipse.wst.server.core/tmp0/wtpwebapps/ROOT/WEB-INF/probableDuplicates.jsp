		...
		<table style="width: 100%;" height="80%" >
			<tr>
				...
				<s:form action="/markDuplicate.action" method="post" 
					...
					<span class="lead">Probably duplicate SID card founds . If SID card has been already issued for the same person , you can mark it Duplicate</span>
					
					
				<br/><br/>
					<s:textarea rows="5" cols="30" name="remark" placeholder="Please mention the reason for issuing / marking as duplicate" style="width:100%;"> </s:textarea>
