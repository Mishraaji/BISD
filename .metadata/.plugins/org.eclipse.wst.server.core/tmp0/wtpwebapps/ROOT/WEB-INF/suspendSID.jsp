...
&nbsp;&nbsp;<i class="step fi-clock size-24"></i>  SID 
</div>
...
<br/><br/><br/>
<s:form action="suspendSID" method="post" 
...
<input type="button" value="Submit" class="medium button" onclick="checkVal()"/>
<s:submit value=" Cancel " action="home" theme="simple" class="medium secondary button"/></td>
</tr>
