...
<div  id="printable">
	<div style="text-align: center;">
		...
		<div>
			<!--
			this div is commented while giving demo to dgshipping, i added background card image file to outer div
			 <div class="zone1">
			...
			<!-- <table style="width: 100%; margin-top: 10%;" > 
				<tr>
					<td width="50%">   SID No:  <span class="content"><s:property value="%{#session.CARD.SIDNo}"/> </span></td>
					<td width="50%" align="right" style="text-align: right;">CDC No: <span class="content"><s:property value="%{#session.CARD.CDCNo}"/></span> </td> 
				</tr>
			</table>-->
			<div class="outer">
				<div class="photo">
					<img alt="" src="<s:url action='ImageAction.action?applicationId=%{#session.CARD.applicationId}&documentType=100' />"
						height="95px" width="80px"><br/>
					
						<img alt="" src="<s:url action='ImageAction.action?applicationId=%{#session.CARD.applicationId}&documentType=102' />"
				...
				<div class="details">
					<div class="inline">
					<table class="cardTable" cellpadding="5px">
					<tr>
					<td colspan="3"><span class="content">Name</span></td>
					</tr>
					<tr>
					<td colspan="3"><span class="content leftAlign"><s:property value="%{#session.CARD.lastName}"/>
					    <s:property value="%{#session.CARD.firstName}"/>
					    <s:property value="%{#session.CARD.midleName}"/></span></td>
					</tr>
					<tr>
							<td width="20%">
								<!-- Nationality -->
						...
						<td width="10%">
								<!-- Sex<br/> -->
								<s:property value="%{#session.CARD.gender}"/>
							</td>
							<td width="70%">
								<!-- Date & place of birth <br/> -->
								<s:property value="%{#session.CARD.dob}"/> 
							</td>
						...
						<td>
								...
								<!-- Date & place of birth <br/> -->
								<s:property value="%{#session.CARD.placeOfBirth}"/>
							</td>
							</tr>
							<tr>
							<td colspan="2"><span class="content">Identification mark</span></td>
								<td colspan="2"><s:property value="%{#session.CARD.identificationMark}"/>
							...
							<tr>
							<td><s:property value="%{#session.CARD.SIDNo}"/> </td>
							<td colspan="2"><!-- Date & place of issue<br/>-->
								<s:property value="%{#session.CARD.dateOfIssue}"/> 
							</td>
								</tr>
							...
							<td width="80%" >
								<!-- Date & place of birth <br/> -->
								<s:property value="%{#session.CARD.dateOfExpiry}"/>
							</td>
						...
						<tr>
							...
							<td width="40%" >
							 <s:property value="%{#session.CARD.placeOfIssue}"/>
							 </td>
							<!-- <td>
								Expiry date<br/>
								<span class="content">&nbsp;</span>
						...
						<tr class="leftAlign">
							<!-- <td>Identification mark  :<br/>
								<s:property value="%{#session.CARD.identificationMark}"/>
		...
		<div class="outer">
			...
			<div class="zone6">
				...
				<img alt="" src="<s:url action='/ImageAction?sidNo=%{#session.CARD.SIDNo}&documentType=barCode'/>" >	 
				</div>
			</div>
			...
			<div class="zone7" style=" font-size:10px; " align="justify">
				...
				<div class="mrzLine2"><s:property value="%{#session.CARD.mrz}"/></div>
