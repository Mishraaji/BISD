...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; Print Report Help
	</div>
						
						
						<p>You see the list of all new applications submitted by seafarers till date.
						</p>
						<h4>Search</h4>
						...
						<h4>Print Report</h4>						
						<p>By clicking on view application link of particular application, it shows the application in print mode.</p>
						<p>Click on print, the printer will print the selected application</p>
						<!--<p align="justify">
