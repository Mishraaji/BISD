...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; VO Help
	</div>
						</br>

						<h5><a href="${pageContext.request.contextPath}/jsp/Help/ioNewAppHelp.jsp">New Applications Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/ioRejectedAppHelp.jsp">Rejected Applications Help</a></h5>
						
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/ioPrintFormHelp.jsp">Print Report Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/ioVerAppHelp.jsp">Verified Applications Help</a></h5>
