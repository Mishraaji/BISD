...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; New Application Help
	</div>
						</br>
						
						<p>You see the list of all verified applications submitted by seafarers till date.
						</p>
						<h4>Search</h4>
						<p>Search: You can search the application of the seafarer by providing application ID (or name or indos number)in the search field.</p>
						<p>
						</p>
...
<p>View Application: By clicking on view application link of particular application, it shows the application in edit mode.</p>
						<p>Verify the INDOS and CDC Details, personal details, address details, and other details of seafarer during interview.</p>
						<p>Verify image and biometric details.</p>
