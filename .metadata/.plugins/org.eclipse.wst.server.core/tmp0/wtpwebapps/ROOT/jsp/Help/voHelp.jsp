...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; Verifying officer Help
						...
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/voNewAppHelp.jsp">New Applications Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/voRejectedAppHelp.jsp">Rejected Applications Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/voAppoinmentHelp.jsp">View Appointments Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/voPrintFormHelp.jsp">Print Report Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/voVerAppHelp.jsp">Verified Applications Help</a></h5>
						<!--<p align="justify">
