...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; DCO Help
	</div>
						</br>

						<h5><a href="${pageContext.request.contextPath}/jsp/Help/NewAppHelp.jsp">New Applications Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/RejectedAppHelp.jsp">Rejected Applications Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/DeoAppoinmentHelp.jsp">View Appointments Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/PrintFormHelp.jsp">Print Report Help</a></h5>
						<h5><a href="${pageContext.request.contextPath}/jsp/Help/VerAppHelp.jsp">Verified Applications Help</a></h5>
						<!--<p align="justify">
