				...
				<tr>
					<td colspan="4" align="center">
						...
						<input type="button" class="secondary button" value="Back" id="tab4Pre" name="tab4Pre">
						 <s:if test="%{#session.USER_ROLE==7}"> 
							<%-- <s:submit method="execute"  value="Generate Replace SID Card" theme="simple" class="success button" id="sbmt"/> --%>
							<s:a action="UpdateReplaceSid.action" class="success button" >Replace SID Card</s:a>
							<%-- <s:a action="UpdateReplaceSid.action" class="success button" >Replace  Card</s:a> --%>
