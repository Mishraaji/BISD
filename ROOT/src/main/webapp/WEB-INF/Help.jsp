...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
				...
				--><td width="75%" valign="top">
					  ...
					  <div class="customHeader2">
						<i class="step fi-graph-horizontal size-24"></i>  &nbsp;&nbsp;Seafarers Help
					</div>
				<br/>
					
						</br>
						<ul class="a">
						<li><h5><s:a action="PersonalHelpJSP">Personal Details Help</s:a></h5></li>
						<%-- <li><h5><s:a action="AddressHelpJSP">Address Details Help</s:a></h5></li> --%>
						<li><h5><s:a action="OtherHelpJSP">Other Details Help</s:a></h5></li>
						<!--<li><h5><a href="PhotoHelp2.jsp">Photo upload Help</a></h5></li>
						--><li><h5><s:a action="AppointmentHelpJSP">Schedule Appointment Help</s:a></h5></li>
						</ul>
						<!--<p align="justify">
