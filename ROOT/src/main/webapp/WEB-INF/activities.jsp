	...
	<div class="twelve column sideBar">
						...
						<div class="customHeader2">
						 ...
						 <ul style="list-style-type: none;">
							...
							<!--<s:a action="makePayment.action" id="make_payment"> 
						 	...
						 	<s:a action="tryPayment.action" id="make_payment"> 
						 		<li><i class="step fi-refresh size-21"></i> Make Payment </li>
						 	</s:a>
							...
							<s:a action="printFormaction"> 
						 	...
						 	<!-- Replace sid card test -->
						 	<s:a action="replace.action" > 
						 		
						 		<li><i class="step fi-foundation size-21"></i> Replace SID </li>
						 	</s:a>
						 	<!-- Replace sid card test code end -->
					...
					<s:elseif test="%{#session.USER_ROLE==6}">
						...
						<!-- View Replace Seafer Appointents to vo Avinash khade -->
						 	...
						 	<%-- <s:a action="replaceSidApplication.action" >
								<s:param name="typeApp">newApp</s:param>
								<s:param name="rePrint">newn</s:param>
						 		<li><i class="step fi-pencil size-21"></i>Replace Card Documents </li>
						 	</s:a> --%>
						 	
						 	<!-- END -->
						 	<!-- NITIN MISHRA DIABLLING THE DUPLICATE CARD APPLICATION -->
						 ...
						 <%-- 	<s:a action="#" > 
							...
							<s:param name="rePrint">newn</s:param>  
						 	...
						 	<%-- <!-- Code Replace Application Avinash -->
						 	<s:a action="replaceSidApplication.action" > 
								<s:param name="typeApp">replaceCardApp</s:param>
								<s:param name="rePrint">replacecard</s:param>
						 		<li><i class="step fi-pencil size-21"></i> Replace card Applications </li>
						 	</s:a> --%>
					...
					<s:elseif test="%{#session.USER_ROLE==7}">
						  <div class="customHeader2">
		    				<i class="step fi-list-thumbnails size-28"></i> IO Menu
						 	...
						 	<%-- <% Replace App show to io for approve%> --%>
						...
						<%--  <s:a action="tryPayment.action" id="make_payment"> 
							...
							<!-- Avinash Khade Genrate Report  -->
							<s:a action="genrateReport.action" >								
								<li><i class="fa fa-history size-21"></i>Genrate Reports</li>
							</s:a>
							
							<!-- Report Status -->
							<s:a action="reportStatus.action" >								
								<li><i class="fa fa-history size-21"></i> Report Status</li>
							</s:a>
						 	<!-- Sidharth Bhawal -->
							<s:a action="changePasswordOfficerJSP" > 
						 		<li><i class="step fi-info size-21"></i> Change Password </li>
					...
					<s:elseif test="%{#session.USER_ROLE==13}">
						  <div class="customHeader2">
		    				<i class="step fi-list-thumbnails size-28"></i> Reception
   						  ...
   						  <ul style="list-style-type: none;" >
   						  <s:a action="getApplicationsRec.action" >								
								<li><i class="step fi-pencil size-21"></i>Today List</li>
							</s:a>
   						  <!-- Deprecated (Vinay Removed This part)  
   						  <s:a action="addtoken.action" >								
								<li><i class="step fi-pencil size-21"></i> Add Token</li>
							</s:a>  -->
							<!-- Added This part Remove token 06-04-2021 Vinay -->
							<s:a action="addtoken.action" >								
								<li><i class="step fi-pencil size-21"></i> Remove Token</li>
							</s:a>
						 	<!-- Sidharth Bhawal -->
						 	<s:a action="applicationsHistory.action" >								
								<li><i class="fa fa-history size-21"></i> Applications History</li>
