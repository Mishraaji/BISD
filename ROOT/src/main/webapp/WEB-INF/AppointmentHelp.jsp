...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; Appointment Help
	</div>
						</br>
						...
						<h4>Cancellation of appointment</h4>
						<p>3 times cancellation is allowed after that seafarer have to make payment again to schedule his appointment</p>
