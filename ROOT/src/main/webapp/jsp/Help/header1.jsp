...
<nav class="top-bar" data-topbar role="navigation">
  ...
  <section class="top-bar-section">
    ...
    <ul class="left">
       ...
       <li class="divider"></li>
       <li><a href="#"> B-SID Guidelines</a></li>
       <li class="divider"></li>
       <li><a href="#"> Collection Centres </a></li>
       <li class="divider"></li>
       <li><a href="http://www.dgshipping.gov.in/"> DG Shipping </a></li>
       <li class="divider"></li>
       <li><a href="#"> INDOS Login </a></li>
       <li class="divider"></li>
     
     
       <li><a href="#"> ILO Guidelines </a></li>
       <li class="divider"></li>
       <li><a href="PhotoHelp2.jsp">Photo Help</a></li>
       <li class="divider"></li>
       <li><a href="http://220.156.189.33/IndosApplication/Indos/CDCChecker.jsp"> CDC Checker </a></li>
       <li class="divider"></li>
