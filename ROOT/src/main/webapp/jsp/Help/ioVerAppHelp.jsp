...
<!--<TD> <span> Text <BR><BR> Longer text that stretches out above text-background color... 
	...
	<i class="step size-24"></i>  &nbsp;&nbsp; Verified Application Help
	</div>
						</br>
						
						<p>You see the list of all verified applications which are verified by you.
						</p>
						<h4>Search</h4>
						<p>Search: You can search the verified application of the seafarer by providing application ID (or name or indos number)in the search field.</p>
						<p>
						</p>
...
<p>View Application: By clicking on view application link of particular application, it shows the application in edit mode.</p>
						...
						<p>Verify his image and take his biometric finger print.</p>
						<p>Verify remarks in the remarks field if any.</p>
						<p>Check the verified option and click on Generate SID Application to forward it to printing officer(with modification).</p>
						<p>In case if you want to reject the application click on reject.</p>
